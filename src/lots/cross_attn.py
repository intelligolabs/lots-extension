    ...
    def __call__(
        ...
        **kwargs,
        ...
        if encoder_hidden_states is None:
            ...
            # end_pos = encoder_hidden_states.shape[1] - self.num_global_tokens
...
# Processors fro IP-Adapter
# Following their procedure to inject cross-attention modules into a pretrained unet
